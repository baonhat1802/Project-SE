...
const data = {
  ...
  order: [
     ...
     */
    {
      ...
      shippingAddress: {
        fullName: "Ninh Tran Hoang Quan",
        address: "227 Nguyen van cu",
        city: "HCMC",
        postalCode: "313233",
        country: "Viet Nam",
        phoneNumber: "09784758374",
      },
      ...
      totalPrice: 15.75,
      user: {
        $oid: "63b83f87181ebca741e3e140",
      },
      isPaid: true,
      isDelivered: false,
      createdAt: {
        $date: {
          $numberLong: "1673034638367",
        },
      },
      updatedAt: {
        $date: {
          $numberLong: "1673034653286",
        },
      },
      __v: 0,
      paidAt: {
        $date: {
          $numberLong: "1673034653284",
        },
      },
      paymentResult: {
        id: "6HM6329251633115T",
        status: "COMPLETED",
        update_time: "2023-01-06T19:50:52Z",
        email_address: null,
      },
    },
  ],
